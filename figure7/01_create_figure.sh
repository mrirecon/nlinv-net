...
bart fmac $WDIR/v6 $SRC/02_nlinv_rovir/img $WDIR/img ;			cfl2png $CON $WDIR/img coeff_nlinv
bart fmac $WDIR/v6 $SRC/04_pics_rovir_l0.003/img $WDIR/img ; 		cfl2png $CON $WDIR/img coeff_pics
bart fmac $WDIR/v6 $SRC/21_rovir_resnet_mse/img $WDIR/img ; 		cfl2png $CON $WDIR/img coeff_mse
bart fmac $WDIR/v6 $SRC/22_rovir_resnet_mad/img $WDIR/img ; 		cfl2png $CON $WDIR/img coeff_mad
bart fmac $WDIR/v6 $SRC/23_rovir_resnet_mse_first/img $WDIR/img ; 	cfl2png $CON $WDIR/img coeff_mse_first
bart fmac $WDIR/v6 $SRC/24_rovir_resnet_mad_first/img $WDIR/img ; 	cfl2png $CON $WDIR/img coeff_mad_first

cfl2png $CON_T1 $SRC/02_nlinv_rovir/img_T1	 	T1_nlinv
cfl2png $CON_T1 $SRC/04_pics_rovir_l0.003/img_T1	T1_pics
cfl2png $CON_T1 $SRC/21_rovir_resnet_mse/img_T1		T1_mse
cfl2png $CON_T1 $SRC/22_rovir_resnet_mad/img_T1		T1_mad
cfl2png $CON_T1 $SRC/23_rovir_resnet_mse_first/img_T1	T1_mse_first
cfl2png $CON_T1 $SRC/24_rovir_resnet_mad_first/img_T1	T1_mad_first
